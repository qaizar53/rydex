      ...
      >
        <div className="px-5 lg:px-8 max-w-6xl mx-auto">
          <motion.div
            ...
            className="bg-zinc-50 border border-zinc-300 rounded-2xl overflow-hidden mb-5"
          >
            <div className="flex gap-3 px-4 py-3 border-b border-zinc-100">
              <div className="flex flex-col items-center pt-1.5 shrink-0">
                ...
                <div
                  className="w-1 bg-zinc-300 my-1 flex-1"
                  style={{ minHeight: 14 }}
                />
              </div>
          ...
          >
            <div>
              <h2 className="font-black tracking-tight text-lg text-zinc-900">
                {loading
                  ? "Finding Vehicles"
                  : vehicles.length > 0
                    ? "Available"
            ...
            <AnimatePresence mode="wait">
              {loading ? (
                ...
                <motion.div
                  ...
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="flex items-center gap-1.5 bg-emerald-50 border border-emerald-200 px-2.5 py-1.5 rounded-full"
                >
                  <Zap
