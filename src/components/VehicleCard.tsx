  ...
  return (
    ...
    >
      <div className="relative h-48 bg-zinc-50 flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute bottom-3 right-3 z-20 flex items-center gap-1.5 bg-zinc-900 text-white text-[10px] uppercase tracking-wider px-2.5 py-1.5 rounded-full">
          <Icon size={10} />
          {label}
        </div>
      ...
      <div className="flex flex-col flex-1 p-5 gap-4">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <h3 className="truncate text-zinc-700 font-bold text-base leading-tight tracking-tight">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="bg-zinc-50 border border-zinc-100 rounded-2xl px-3.5 py-3">
            ...
            <div className="text-zinc-900 text-sm flex items-center font-black">
              <IndianRupee size={12} /> {vehicle.waitingCharge}
              <span>/min</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-end justify-between pt-3 border-t border-zinc-100">
          <div>
            ...
            >
              <IndianRupee
                size={16}
                className="mb-0.5 text-zinc-900"
                strokeWidth={2.5}
              />
