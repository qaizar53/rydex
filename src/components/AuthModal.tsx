                ...
                <div>
                  ...
                  {step == "login" && (
                    ...
                    >
                      ...
                      <div className="mt-5 space-y-4">
                        ...
                        <button
                          className="w-full h-11 rounded-xl border border-black/20 flex items-center justify-center gap-3 text-sm font-semibold bg-black hover:bg-black/80 hover:text-white text-white transition"
                  ...
                  {step == "otp" && (
                    ...
                    >
                      ...
                      <button
                        className="mt-6 w-full h-11 rounded-xl bg-black text-white font-semibold hover:bg-gray-900 transition flex items-center justify-center"
